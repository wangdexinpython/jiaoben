...
async def fliggy_index_page():
    ...
    await page.goto(url='https://ihouse.ifeng.com/survey/newvotegq/vote?type=zmt&from=singlemessage&isappinstalled=0')


    username, pwd = '18310761194', 'jiexin'
    await page.click('.cur + span')

    # await page.click('.forget-pwd J_Quick2Static')

    # body > section > div.vote - con > div.vote - main > ul: nth - child(2) > li:nth - child(9) > div.vote - c > a
    await page.type('#username', username, {'delay': 30})
    await page.type('#password', pwd, {'delay': 800})
