...
function encryptedString(n,t){
    ...
    for(e=a.length,o="",r=0;r<e;r+=n.chunkSize){
        ...
        for(u[n.digitSize-2]=2,u[n.digitSize-1]=0,h=0;h<n.digitSize;++s)c.digits[s]=u[h++],c.digits[s]+=u[h++]<<8;l=n.barrett.powMod(c,n.e);y=n.radix==16?biToHex(l):biToString(l,n.radix);o+=y+" "}
...
var pwd = encryptedString(RSAKeyPair,'jiexin')